...
| RISK-GATE-008 | ARP-008 controlled safety test evidence | `certification/testing/ARP_008_CONTROLLED_EVIDENCE/`; `docs/governance/ARP_008_CONTROLLED_EVIDENCE_CAPTURE_REPORT.md` | CAPTURED | Controlled evidence captures passing AntiBleedGuard, MarginTradeGate enforcement, security, legal acceptance, and RiskGovernor tests; Robert review remains required. |
