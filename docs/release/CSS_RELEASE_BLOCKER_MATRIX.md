...
| RB-012 | Endurance/DR proof absent or simulated; evaluator-only continuity | Critical | Gate 2 operational acceptance | endurance clock injection tests; OV-002 Attempt 1 INVALIDATED (~25.2h; commit drift); Phase 181 endurance/DR docs; Master Audit §5.9 | AR-014 fresh 72h Attempt 2 required; AR-015 restore drill CLOSED | PARTIALLY CLOSED |
