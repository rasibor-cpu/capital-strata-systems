...
| --- | --- | --- | --- | --- | --- | --- |
| RB-001 | Production certification result is `NOT CERTIFIED`; compile/regression/OAT/endurance/recovery unverified | Critical | Gate 2 / Production Certification | `runtime_reports/phase181_certification/CERTIFICATION_SUMMARY.md`; Batch 2 assessment; Master Audit §5.1, §8 | AR-011 CLOSED as NOT_CERTIFIED disposition; earn CERTIFIED only after operational residuals (013/014/040 + platform) | PARTIALLY CLOSED |
