...
| Strategy intelligence | `backend/options/options_intelligence_engine.py` validates candidate rows by premium, DTE, delta, volume, open interest, spread, liquidity, and score; delegates to strategy/payoff/risk engines. | Opportunity selection exists for directional/debit-spread strategies only. OI-002 income models are not yet wired into scanning. |
...
| Covered calls | COMPLETE_PENDING_CERTIFICATION | `backend/options/options_income_strategy_domain.py`; `backend/options/option_payoff_engine.py`; `backend/options/option_risk_profile_engine.py` | `tests/test_oi002_income_strategy_domain_model.py` | Domain/payoff/risk model only; no orchestration | None | Placeholder only | OI-002 governance doc | Paper-safe domain model exists; no scan, lifecycle, assignment execution, roll, broker, or dashboard activation |
| Cash-secured puts | COMPLETE_PENDING_CERTIFICATION | `backend/options/options_income_strategy_domain.py`; `backend/options/option_payoff_engine.py`; `backend/options/option_risk_profile_engine.py` | `tests/test_oi002_income_strategy_domain_model.py` | Domain/payoff/risk model only; no orchestration | None | Placeholder only | OI-002 governance doc | Paper-safe domain model exists; no scan, lifecycle, assignment execution, Wheel handoff, broker, or dashboard activation |
...
| Covered Calls | NOT_PRESENT: OI-002 does not scan opportunities | COMPLETE_PENDING_CERTIFICATION: paper-safe domain builder validates canonical contract and share coverage | NOT_PRESENT | NOT_PRESENT | NOT_PRESENT: assignment exposure is modeled, assignment execution is not | NOT_PRESENT | COMPLETE_PENDING_CERTIFICATION: share coverage, payoff, downside, capped upside, and advisory flags are tested | PLACEHOLDER: no dashboard/reporting activation | COMPLETE_PENDING_CERTIFICATION: `tests/test_oi002_income_strategy_domain_model.py` |
| Cash-Secured Puts | NOT_PRESENT: OI-002 does not scan opportunities | COMPLETE_PENDING_CERTIFICATION: paper-safe domain builder validates canonical contract and cash collateral | NOT_PRESENT | NOT_PRESENT | NOT_PRESENT: assignment exposure is modeled, assignment execution is not | NOT_PRESENT | COMPLETE_PENDING_CERTIFICATION: cash collateral, payoff, downside, assignment cost basis, and advisory flags are tested | PLACEHOLDER: no dashboard/reporting activation | COMPLETE_PENDING_CERTIFICATION: `tests/test_oi002_income_strategy_domain_model.py` |
...
- Covered call strategy builder with stock/share coverage validation. OI-002 provides the paper-safe domain model; scan, lifecycle, and runtime integration remain outstanding.
- Cash-secured put strategy builder with cash collateral validation. OI-002 provides the paper-safe domain model; scan, lifecycle, and runtime integration remain outstanding.
...
2. The blockers to a complete institutional Options Income Engine are income opportunity scanning, collateral and assignment-aware lifecycle, options-specific risk governance, broker state authority, evidence/journal/runtime-event integration, dashboard/reporting for income workflows, and production certification. Existing files support directional long options, debit-spread math, Greeks, paper lifecycle, display surfaces, and OI-002 covered-call/cash-secured-put domain models; they do not implement Wheel, assignment execution, rolling, live broker options integration, or income runtime activation.

3. Phase OI-002 completed the paper-only income strategy domain phase by adding covered-call and cash-secured-put builders plus collateral/share-coverage validators and deterministic tests, without broker changes or live execution. The next smallest implementation phase is OI-003 income opportunity scanning and contract selection.
