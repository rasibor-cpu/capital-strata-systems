...
class ExecutionEngine:
    ...
    def regime_factor(self, regime_state: str, trade: Trade) -> float:
        ...
        if regime_state == "STRONG":
            ...
            # 🔥 Phase 11.4 — Edge-weighted scaling
...
class Dashboard:
    ...
    def run(self):
        ...
        print("\nCSS PHASE 11.4 — EDGE-WEIGHTED NEUTRAL ACTIVE\n")
        ...
        while True:
            ...
            for asset in RESERVED_ORDER:
                reg = self.regime.evaluate_asset(asset, grouped.get(asset, []))
            ...
            for asset in RESERVED_ORDER:
                ...
                candidates = sorted(grouped.get(asset, []), key=lambda x: x.score, reverse=True)
                ...
                print(f"{t.symbol} | {asset} | Size: {round(size,2)} | {out} | PnL: {round(pnl,2)}")
