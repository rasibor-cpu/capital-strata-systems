...
TOP_N_PER_ASSET = 2  # 🔥 Phase 12.3 (core upgrade)
...
class Executor:
    ...
    def size(self, bal, trade, regime):
        ...
        size = bal * BASE_RISK_PER_TRADE * base_weight * tilt
        ...
        return min(size, MAX_POSITION_SIZE_BY_ASSET[trade.asset_class])
...
class Dashboard:
    ...
    def run(self):
        ...
        print("\nCSS PHASE 12.3 — MULTI-TRADE ACTIVE\n")
        ...
        while True:
            ...
            for asset in RESERVED_ORDER:
                ...
                selected = sorted(asset_trades, key=lambda x: x.net_edge, reverse=True)[:TOP_N_PER_ASSET]

                for t in selected:

                    size = self.executor.size(self.balance, t, regime)
