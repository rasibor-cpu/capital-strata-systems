...
def run_portfolio():
    ...
    for asset in assets:
        ...
        r = backtest_asset(asset, capital/3, 900)
    ...
    for r in results:
        ...
        weight = r["score"] / total_score if total_score > 0 else 1/len(results)

        r["allocation"] = round(weight, 3)
...
def main():
    ...
    f = OUT / f"portfolio_backtest_v13_{stamp}.json"
