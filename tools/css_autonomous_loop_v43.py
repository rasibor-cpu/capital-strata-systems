...
def log_trade(trade):
    ...
    path = LOG_DIR / f"trade_{trade['asset']}_{ts}.json"
...
def run_cycle():
    ...
    print("\n==============================")
    print("CSS AUTONOMOUS ENGINE v43")
...
def main():
    ...
    print("\nCSS AUTONOMOUS ENGINE v43 STARTED\n")
