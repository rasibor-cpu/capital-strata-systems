"""
CSS Autonomous Loop v59
Position Accounting + Hardened Profit Ladder Engine
"""
...
def print_header():
    ...
    print("\n" + "=" * 70)
    print(" CAPITAL STRATA SYSTEMS — HARDENED TREND ENGINE ")
    print("=" * 70)
...
def main():
    ...
    while True:
        ...
        if not position and best:
            ...
            if price:
                ...
                if move >= LADDER_1 and not position["ladder1_done"]:
                    ...
                    print("\nLADDER 1 EXECUTED — 25% PROFIT LOCKED")
                ...
                if move >= LADDER_2 and not position["ladder2_done"]:
                    ...
                    print("\nLADDER 2 EXECUTED — ADDITIONAL PROFITS LOCKED")

                trail = position["highest_price"] * (1 - TRAIL_STOP)

                print(
                    f"\nHOLD {position['asset']} price={price} unrealized={unrealized:.2f} trail={trail:.2f}"
                )
                ...
                if price < trail:
                    ...
                    print(f"\nFINAL EXIT — TOTAL PROFIT {position['realized_profit']:.2f}")
        ...
        if position:
            ...
            print("Realized Profit:", position["realized_profit"])
