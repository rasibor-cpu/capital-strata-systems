...
Autonomous Trader v32

Pipeline
scan market
→ select best assets
→ run trend-pullback strategy
...
def evaluate_trade(asset):
    ...
    if ema20 > ema50 and price < ema20:
        ...
        print(asset, "→ PULLBACK ENTRY SIGNAL")

    elif ema20 > ema50:

        print(asset, "→ TREND OK, WAITING FOR PULLBACK")

    else:

        print(asset, "→ NO TREND")


def main():

    print("\nCSS AUTONOMOUS TRADER v32\n")
