...
def portfolio_statistics():
    ...
    profit_factor = profit / loss if loss else 0

    print("\n--- Portfolio Stats ---")
    print("Trades:", len(history))
...
def run_cycle():
    ...
    print("\n==============================")
    print("CSS AUTONOMOUS ENGINE v45")
...
def main():
    ...
    print("\nCSS AUTONOMOUS ENGINE v45 STARTED\n")
