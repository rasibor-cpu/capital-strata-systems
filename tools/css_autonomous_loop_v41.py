...
def run_cycle():
    ...
    print("\n==============================")
    print("CSS AUTONOMOUS ENGINE v41")
...
def main():
    ...
    print("\nCSS AUTONOMOUS ENGINE v41 STARTED\n")
