...
Portfolio Backtest Engine v12
Higher-quality VWAP mean reversion
15-minute timeframe
"""
...
def run_portfolio():
    ...
    for asset, weight in alloc.items():
        ...
        r = backtest_asset(asset, capital * weight, 900)
...
def main():
    ...
    f = OUT / f"portfolio_backtest_v12_{stamp}.json"
