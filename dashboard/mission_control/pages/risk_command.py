...
def render(state: dict) -> str:
    ...
    return (
        ...
        + '<nav class="mc-page-jump" aria-label="Risk Command sections">'
          '<a href="#mc-risk-limits">Limits & Stress</a>'
          '<a href="#mc-risk-command">Command</a>'
          '<a href="#mc-risk-profit-protection">Profit Protection</a>'
          '<a href="#mc-risk-committee">Committee</a>'
          '</nav>'
        + metric_grid(
            (
        ...
        + _anchor_panel("mc-risk-dimensions", detail_table("Risk Dimensions", {
        ...
        + _anchor_panel("mc-risk-command", detail_table("Risk Command Projection", {
        ...
        + _anchor_panel("mc-risk-profit-protection", detail_table("Profit Protection Governance", {
        ...
        + _anchor_panel("mc-risk-committee", detail_table("Risk Committee", {
