...
MISSION_CONTROL_SECTIONS: tuple[MissionControlSection, ...] = (
    ...
    MissionControlSection("user_account_configuration", "User Accounts & Commercial Terms", "/mission-control/user-account-configuration", "User privileges, user mode, system access charges, trade commissions, and acceptance records.", "users"),
