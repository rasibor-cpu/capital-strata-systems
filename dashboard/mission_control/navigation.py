...
MISSION_CONTROL_SECTIONS: tuple[MissionControlSection, ...] = (
    ...
    MissionControlSection("audit_explainability", "Audit and Readiness", "/mission-control/audit-explainability", "Decision explanations, evidence, correlation IDs, audit events, warnings, failures, and readiness.", "badge"),
