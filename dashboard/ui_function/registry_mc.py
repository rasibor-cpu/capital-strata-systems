...
def _mc_reports() -> list[CSSUIFunctionDefinition]:
    ...
    for action, api, service in (
        ...
        ("detail_pdf", "GET /api/v1/reports/{id}/pdf", "ReportsCenterService.pdf_bytes"),
        ("detail_pdf_status", "GET /mission-control/api/reports/{id}/pdf-info", "ReportsCenterService.print_info"),
