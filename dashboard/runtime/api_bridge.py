...
def get_post_pilot_evidence_archive_export_payload(
    state_provider: DashboardStateProvider | None = None,
    event_bus: RuntimeEventBus | None = None,
) -> dict[str, Any]:
    reconciliation = get_post_pilot_reconciliation_payload(
        state_provider,
        event_bus,
    )
    return build_post_pilot_evidence_archive_export_payload(
        reconciliation=reconciliation,
        operator_conclusion="operator conclusion pending",
    )
...
def get_evidence_signature_readiness_payload(
    state_provider: DashboardStateProvider | None = None,
    event_bus: RuntimeEventBus | None = None,
) -> dict[str, Any]:
...
def get_evidence_verification_checklist_payload(
    state_provider: DashboardStateProvider | None = None,
    event_bus: RuntimeEventBus | None = None,
) -> dict[str, Any]:
    verification_readiness = get_evidence_verification_readiness_payload(
        state_provider,
        event_bus,
    )
...
def create_dashboard_state_router(
    ...
    *,
    ...
    @router.get("/api/v1/post-pilot-evidence-archive-export")
    def read_post_pilot_evidence_archive_export() -> dict[str, Any]:
        return get_post_pilot_evidence_archive_export_payload(
            state_provider,
            runtime_event_bus,
        )
    ...
    @router.get("/api/v1/evidence-signature-readiness")
    def read_evidence_signature_readiness() -> dict[str, Any]:
        return get_evidence_signature_readiness_payload(
            state_provider,
            runtime_event_bus,
        )
    ...
    @router.get("/api/v1/evidence-verification-checklist")
    def read_evidence_verification_checklist() -> dict[str, Any]:
        return get_evidence_verification_checklist_payload(
            state_provider,
            runtime_event_bus,
        )
