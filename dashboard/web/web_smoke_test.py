...
def main() -> int:
    ...
    expected_pilot_markup = [
        ...
        "Post-Pilot Evidence Archive Export",
        "Archive Export Evidence Links",
        "No archive file is written from this page",
        "Archive Manifest Hash",
        "Archive manifest hashing is integrity evidence only",
        "Signature Readiness",
        "No signing key is loaded and no digital signature is generated",
        "Notarization Readiness",
        "No external notarization is performed and no notarization file is written",
        "Evidence Verification Readiness",
        "No external archive file is read and no verification is performed",
        "Evidence Verification Checklist",
        "Manual verification is not recorded and no archive file is read",
        "Verification Checklist Missing Items",
        "Required Approvals",
        "Coinbase Advanced",
        "BTC-USD",
        "CAD $15",
