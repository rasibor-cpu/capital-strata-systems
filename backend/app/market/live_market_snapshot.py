"""Phase 185A — immutable market microstructure snapshot contract.

No broker I/O. Snapshots are constructed by certified offline providers only.
Default posture is NOT_AVAILABLE / UNKNOWN (fail-closed).
This contract is data/intelligence infrastructure only: diagnostics,
simulation, certification, and offline validation. It grants no order or
trade authority and is not wired into execution gates.
...
class LiveMarketSnapshot:
    """Immutable market microstructure snapshot for diagnostics and certification."""
