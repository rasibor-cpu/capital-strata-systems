...
from backend.app.risk.live_microstructure_provider import LiveMicrostructureInputs
...
class OfflineMicrostructureResult:
    ...
    available: bool
    inputs: Optional[LiveMicrostructureInputs]
    reasons: tuple[str, ...] = ()
...
class OfflineCertificationMicrostructureProvider:
    """Combines snapshot + fee + slippage for offline AntiBleed certification."""
