...
def _base(
    *,
    ...
    expiry_threshold_seconds: int | None = None,
    ...
    payload: dict[str, Any] = {
        ...
        "acquisition_timestamp": received_at or generated_at,
        "stale_threshold_seconds": stale_threshold_seconds,
        "expiry_threshold_seconds": expiry_threshold_seconds,
        "advisory_status": advisory_status or status,
        "freshness": freshness,
        "quality": quality,
...
def market_data_envelope(**kwargs: Any) -> dict[str, Any]:
    ...
    return _base(
        **{
            ...
            "stale_threshold_seconds": kwargs.get("stale_threshold_seconds"),
            "expiry_threshold_seconds": kwargs.get("expiry_threshold_seconds"),
            "advisory_status": kwargs.get("advisory_status"),
    ...
    return _base(
        **{
            ...
            "extra": {
                ...
                "maintenance_excess": kwargs.get("maintenance_excess"),
                "option_collateral": kwargs.get("option_collateral"),
                "equity": kwargs.get("equity"),
                "balances": list(kwargs.get("balances") or []),
