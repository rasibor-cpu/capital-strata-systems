...
class CommercializationUatScenario(str, Enum):
    ...
    CONTRACT_VERSION_MISMATCH_BLOCKED = "CONTRACT_VERSION_MISMATCH_BLOCKED"
    RESTART_PERSISTENCE = "RESTART_PERSISTENCE"
    PAYMENT_SANDBOX_IDEMPOTENCY = "PAYMENT_SANDBOX_IDEMPOTENCY"
    NOTIFICATION_SANDBOX_IDEMPOTENCY = "NOTIFICATION_SANDBOX_IDEMPOTENCY"
    SANDBOX_PROVIDER_CANNOT_UNLOCK_PRODUCTION = "SANDBOX_PROVIDER_CANNOT_UNLOCK_PRODUCTION"
    LAUNCH_OPS_READ_ONLY = "LAUNCH_OPS_READ_ONLY"
    CUSTOMER_WEB_SMOKE = "CUSTOMER_WEB_SMOKE"
    BROKER_EXECUTION_FAIL_CLOSED = "BROKER_EXECUTION_FAIL_CLOSED"
