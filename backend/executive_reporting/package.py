    ...
    *,
    ...
    package = {
        ...
        "metadata": {
            ...
            "report_classification": "MANAGEMENT_NOT_AUDITED",
            "board_investor_regulatory_scope": "OUT_OF_SCOPE",
            "eis_182a_released": False,
        ...
        "limitations": [
            ...
            "Board/investor/regulatory packs are OUT OF SCOPE for Gate 2 (AR-047).",
            "Full EIS/182A dashboard is DEFERRED (AR-018).",
        ],
