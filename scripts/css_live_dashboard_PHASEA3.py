...
# ============================================================
# PHASE A2C — GLOBAL EXECUTION PROBABILITY GATE
# ============================================================
def phase_a2_allow_trade(prob):
    if prob < 0.55:
        print(f"[PHASE A2C BLOCK] prob={prob:.3f} below A3 threshold")
        return False
    return True
...
try:
    ...
    class Portfolio:
        ...
        def close_position(self, symbol: str, exit_price: float) -> float:
            ...
            # PCNRASS PACK 3 — COST MODEL
            # Deduct controlled entry and exit friction from realized PnL so
            # paper/accounting results are not overstated by transaction costs.
        ...
        if is_session_locked():
            ...
            if not role_profile.get("can_execute_paper_trading", False):
                ...
                for asset_class, symbol, sig, prob in cycle_candidates:
                    ...
                    min_sig, min_prob = mode_filter.get(ENGINE_MODE, (11.5, 0.55))
